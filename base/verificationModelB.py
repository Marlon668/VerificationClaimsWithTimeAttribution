...
from base.labelMaskDomainB import labelMaskDomain
from base.dataset import dump_load, dump_write, NUS
from base.encoderClaimB import encoderClaim
from base.encoderEvidence import encoderEvidence
from base.encoderMetadataB import encoderMetadata
from base.evidence_rankerB import evidenceRanker
from base.instanceEncoderB import instanceEncoder
from base.labelEmbeddingLayerB import labelEmbeddingLayer
from base.OneHotEncoderB import oneHotEncoder
...
class verifactionModel(nn.Module):
    ...
    def getBaseLine(self, encodingClaim, encodingEvidence, metadata):
        with torch.no_grad():
            ...
            low, high = -0.25, 0.25
            while (abs(differenceToZero) > 1e-3):
    ...
    def saving_NeuralNetwork(model):
        pathI ="/scratch/leuven/347/vsc34763/finalResults/basis/modelC/"+model.domain
    ...
    def loading_NeuralNetwork(model):
        pathI ="D:/models/basis/modelC/"+model.domain
...
def preprocessing(models, epochs=600):
    with torch.no_grad():
        for model in models:
            model[1].eval()
            validation_loss, microF1Test, macroF1Test = eval_loop(model[10], model[1], oneHotEncoderM, domainLabels,
