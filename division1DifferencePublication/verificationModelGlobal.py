...
import numpy as np
import random
from division1DifferencePublication.pytorchtools import EarlyStopping

import torch.nn.functional as F
import torch
from torch.utils.data import DataLoader

from division1DifferencePublication.labelMaskDomain import labelMaskDomain
'''
...
from division1DifferencePublication.instanceEncoder import instanceEncoder
from division1DifferencePublication.labelEmbeddingLayer import labelEmbeddingLayer
...
def eval_loop(dataloader, model,oneHotEncoder,domainLabels,domainLabelIndices,device):
    ...
    #transformer = SentenceTransformer('paraphrase-distilroberta-baseModel-v1')
    with torch.no_grad():
        for c in dataloader:
