...
from uitbreiding1En2.pytorchtools import EarlyStopping

import torch.nn.functional as F
import torch
from torch.utils.data import DataLoader

from uitbreiding1En2.labelMaskDomain import labelMaskDomain
'''
combining pre-created partitions into one dataset
'''
from uitbreiding1En2.datasetIteratie2Combiner import dump_load, dump_write, NUS
'''
...
'''
from uitbreiding1En2.encoderMetadata import encoderMetadata
from uitbreiding1En2.evidence_ranker import evidenceRanker
from uitbreiding1En2.instanceEncoder import instanceEncoder
from uitbreiding1En2.labelEmbeddingLayer import labelEmbeddingLayer
from uitbreiding1En2.OneHotEncoder import oneHotEncoder
from torch import nn
from sklearn.metrics import f1_score

from uitbreiding1En2.encoderGlobal import encoder
    ...
    for domain in domains:
        '''
            ...
            train_set = NUS(mode='Train', path=os.pardir + '/train/train-' + domain + '.tsv', domain=domain,
                            pathToSave=sys.argv[4], number=1)
