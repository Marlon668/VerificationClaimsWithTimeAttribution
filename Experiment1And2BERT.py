...
'''
    ...
    argument 3 path of first model division1DifferencePublication
    argument 4 path of second model division1DifferencePublication
    argument 5 path of first model division2DifferenceTimeText
