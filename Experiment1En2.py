...
from uitbreiding2VerschilTijdTekst.encoderGlobal import encoder as encoderTekst
...
from uitbreiding2VerschilTijdTekst.verificationModelGlobal import verifactionModel as verificationTekst
...
'''
    ...
    argument 4 path of first model uitbreiding1VerschilPublicatie
    argument 5 path of second model uitbreiding1VerschilPublicatie
    argument 6 path of third model uitbreiding1VerschilPublicatie
    argument 7 path of first model uitbreiding2VerschilTijdTekst
    argument 8 path of second model uitbreiding2VerschilTijdTekst
    argument 9 path of third model uitbreiding2VerschilTijdTekst
    argument 10 path of first model uitbreiding1En2
    argument 11 path of second model uitbreiding1En2
    argument 12 path of third model uitbreiding1En2
