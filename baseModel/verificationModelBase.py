...
import numpy as np
from baseModel.pytorchtools import EarlyStopping

import torch.nn.functional as F
import torch
from torch.utils.data import DataLoader

from baseModel.labelMaskDomainBasis import labelMaskDomain
from dataset import dump_load, dump_write, NUS
from baseModel.encoderBase import encoder
from baseModel.encoderMetadataBasis import encoderMetadata
from baseModel.evidence_rankerBasis import evidenceRanker
from baseModel.instanceEncoderBasis import instanceEncoder
from baseModel.labelEmbeddingLayerBasis import labelEmbeddingLayer
from baseModel.OneHotEncoderBasis import oneHotEncoder
...
if __name__ == "__main__":
    ...
    if sys.argv[2] == "evaluation":
        ...
        for model in domainModels:
            ...
            print("Results model after training " + model[4])
        ...
        with torch.no_grad():
            for model in domainModels:
                ...
                NNmodel.eval()
                print("Results model after preprocessing " + ' ' + model[4])
